...
public class ProfileActivity extends AppCompatActivity {
    BottomNavigationView bnvToolBarProfile;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        bnvToolBarProfile = findViewById(R.id.bnvToolBarProfile);


        bnvToolBarProfile.setOnNavigationItemSelectedListener(new BottomNavigationView.OnNavigationItemSelectedListener() {
            @Override
